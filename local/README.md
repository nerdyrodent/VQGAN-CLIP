...
## Random object from the ACMI API

To use a random object from the ACMI API, run:
...
<img src="../samples/acmi-74.png" width="256px"></img><img src="../samples/acmi-74.gif" width="256px"></img>
